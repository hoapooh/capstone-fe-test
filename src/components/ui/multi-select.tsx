        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "bg-main-dark-bg-1 hover:bg-main-dark-bg-1/80 flex h-auto min-h-10 items-center justify-between rounded-md border border-white/30 p-1 [&_svg]:pointer-events-auto",
            ...
            >
              {selectedValues.length > 0 ? (
                ...
                <div className="mx-auto flex w-full items-center justify-between">
                  <span className="text-muted-foreground mx-2 text-sm">{placeholder}</span>
