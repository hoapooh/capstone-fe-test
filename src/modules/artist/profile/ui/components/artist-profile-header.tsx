...
import { useArtistProfileImageUpload } from "../../hooks/use-artist-profile-image-upload";
...
export default React.memo(function ArtistProfileHeader({
  name,
  avatarUrl,
  backgroundUrl,
  userId = "",
}: ArtistProfileHeaderProps) {
  const { uploadAvatar, uploadBackground, isUploadingAvatar, isUploadingBackground } =
    useArtistProfileImageUpload(userId);
    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="absolute top-3 right-3 z-20">
          ...
          >
            <label
              htmlFor="artist-profile-bg-upload"
        ...
        <div className="absolute top-1/2 left-4 z-20 -translate-y-1/2 px-2 md:left-6 md:px-0">
          <div className="flex items-center gap-4">
            <div className="relative">
              ...
              >
                <label
                  htmlFor="artist-profile-avatar-upload"
            ...
            <div className="pb-2 md:block">
              ...
              <p className="text-muted-foreground text-sm">Artist Profile</p>
            </div>
          </div>
        </div>
      </div>
